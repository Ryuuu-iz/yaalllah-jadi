...
<div class="px-4 py-6 sm:px-0">
    <div class="mb-6">
        <a href="{{ route('admin.materials.show', $material->id_materi) }}" class="text-blue-600 hover:text-blue-800 flex items-center">
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-gray-900">Edit Material: {{ $material->nama_materi }}</h1>
            <p class="mt-1 text-sm text-gray-600">Update the learning material information</p>
        </div>

        <form action="{{ route('admin.materials.update', $material->id_materi) }}" method="POST" enctype="multipart/form-data" class="px-6 py-4">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_materi" id="nama_materi" value="{{ old('nama_materi', $material->nama_materi) }}" required
                ...
                <div>
                    ...
                    <textarea name="desk_materi" id="desk_materi" rows="4"
                        ...
                        placeholder="Describe what this material covers...">{{ old('desk_materi', $material->desk_materi) }}</textarea>
                    @error('desk_materi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 mt-1">{{ basename($material->file_materi) }}</p>
                            </div>
                        </div>
                        <a href="{{ Storage::url($material->file_materi) }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center">
                ...
                <div>
                    <label for="file_materi" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $material->file_materi ? 'Replace Material File (Optional)' : 'Upload Material File (Optional)' }}
                    </label>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <ul class="list-disc list-inside space-y-1">
                                    ...
                                    <li>Students will see the updated material immediately</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.materials.show', $material->id_materi) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-6 py-2 rounded-md transition-colors">
                    Cancel
                </a>
