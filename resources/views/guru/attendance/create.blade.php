        ...
        <form action="{{ route('guru.attendance.store') }}" method="POST" class="p-6 space-y-6" x-data="{ 
            ...
            <div>
                ...
                <select name="id_course" 
                        ...
                        @change="loadStudents()"
                        required
                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-orange-500 focus:ring-orange-500 @error('id_course') border-red-500 @enderror">
            ...
            <div>
                ...
                <input type="date" 
                       ...
                       required
                       max="{{ date('Y-m-d') }}"
                       class="w-full border-gray-300 rounded-lg shadow-sm focus:border-orange-500 focus:ring-orange-500 @error('tanggal') border-red-500 @enderror">
                @error('tanggal')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <!-- Self Attendance -->
                    <label class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none" :class="mode === 'self' ? 'border-orange-500 ring-2 ring-orange-500' : 'border-gray-300'">
                        ...
                        <svg class="h-5 w-5 text-orange-600" :class="mode === 'self' ? 'block' : 'hidden'" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                    </label>

                    <!-- Manual Attendance -->
                    <label class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none" :class="mode === 'manual' ? 'border-orange-500 ring-2 ring-orange-500' : 'border-gray-300'">
                        ...
                        <svg class="h-5 w-5 text-orange-600" :class="mode === 'manual' ? 'block' : 'hidden'" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                    </label>
                </div>
            ...
            <div x-show="mode === 'self'" x-transition>
                ...
                <input type="datetime-local" 
                       ...
                       class="w-full border-gray-300 rounded-lg shadow-sm focus:border-orange-500 focus:ring-orange-500 @error('deadline') border-red-500 @enderror">
                @error('deadline')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
